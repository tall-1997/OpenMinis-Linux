...
class AlarmOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleSet(args: OffloadArgs): NativeOffloadResult {
        ...
        // dual-writing produced ghost reminders that fired only inside Minis Ultra
     ...
     * dual-writing produced ghost alarms that fired only inside Minis Ultra
    ...
    private fun handleTimer(args: OffloadArgs): NativeOffloadResult {
        ...
        // produced timers that fired only inside Minis Ultra with no Clock UI to
    ...
    private fun buildSetEnvelope(
        ...
        return JSONObject().apply {
            ...
            put("hint", "Alarm saved to the system Clock app. Open the Clock app, or $VIEW_URL inside Minis Ultra, to view or cancel.")
        }
    }
    ...
    private fun buildTimerEnvelope(label: String, durationSec: Int): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("view_url", VIEW_URL)
            put("hint", "Timer started in the system Clock app. Open the Clock app's Timer tab, or $VIEW_URL inside Minis Ultra, to view or stop.")
        }
    }
